//line
console.log("Individual.js is connected")
...
$(document).ready(function() {
	...
	$("#calculate-btn").on("click", function() {
		var calculateAndDisplayScore = function() {
            ...
            var paperInput = document.getElementById("paper").value;
            ...
            var ghgInput = document.getElementById("ghg").value;
			...
			if (paperInput === 0 || paperInput === "undefined") {
				paperScore = 0;
			} else {
				paperScore = paperInput * 105;
			}
			...
			var energyScore = electricScore + paperScore ;
